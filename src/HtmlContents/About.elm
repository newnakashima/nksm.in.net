    ...
    , body =
        ...
        , main_ []
            ...
            , p []
                ...
                , text "主にやっているのはWEBのサーバーサイド、AWS環境設計などです。"
            ...
            , section []
                [ h3 [] [ text "商店街活性化の団体で契約職員" ]
                , p []
                    [ text "地方都市の商店街活性化団体で契約職員をしました。"
                    , text "買物弱者問題解決のためのスマホアプリ運用スタッフを募集していたので、面白そうだと重い応募しました。"
                    , text "丁度そのころ買物弱者の問題に興味を持っていました。"
                    ]
                ]
            , section []
                [ h3 [] [ text "小さなソフト開発会社で受託開発" ]
                , p []
            ...
            , section []
                ...
                , p []
                    ...
                    , text "一年と数ヶ月働いたあと小さい会社に転職しました。そこは将来的に独立もアリと求人に書いてありました。"
            ...
            , section []
                ...
                , p []
                    ...
                    , text "PHPを中心としたLinux環境のサーバーサイド開発が中心ですが、いろいろ楽しい仕事をやっていこうと思っています。"
